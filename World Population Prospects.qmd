...
```{r}
data4<-raw_data_rounded[,c("total_deaths_thousands","male_deaths_thousands", "female_deaths_thousands")]

df2<-data4 %>% pivot_longer(cols=c("total_deaths_thousands","male_deaths_thousands", "female_deaths_thousands"),names_to='deaths_for_gender',
                           values_to='values')
